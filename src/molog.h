...
#define DEFAULT_CONFIG_FILE CONFDIR "/molog.conf"
#define DEFAULT_PID_FILE "/var/run/molog.pid"
#define NONPRINTABLE_SUSTITUTE_CHAR '_'
#define PROGNAME_MASTER "molog [MASTER]"
#define PROGNAME_KERNEL "molog [KERNEL]"
